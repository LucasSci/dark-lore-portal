...
/**
 * ⚡ Bolt: Removed array maps and spread syntax to prevent "Maximum call stack size exceeded"
 * on large polygons and eliminate intermediate array garbage collection overhead.
 */
