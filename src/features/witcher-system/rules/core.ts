import {
  WITCHER_ATTRIBUTES as ATTRIBUTES,
  WITCHER_BACKGROUNDS,
  WITCHER_HIT_LOCATIONS as WITCHER_HIT_LOCATION_TABLE,
  WITCHER_HOMELANDS,
  WITCHER_INVENTORY,
  WITCHER_PROFESSIONS as CLASSES,
  WITCHER_RACES as RACES,
  WITCHER_SCHOOLS as WITCHER_SCHOOLS_LIST,
  WITCHER_SIMPLE_CRITICALS as WITCHER_SIMPLE_CRITICAL_TABLE,
  WITCHER_SPELLS as SPELLS,
...
import type { WitcherAttributeKey } from "../types";
...
export {
  ...
  WITCHER_HOMELANDS,
  WITCHER_INVENTORY as INVENTORY_ITEMS,
...
export function xpForLevel(level: number) {
  const thresholds = [0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400];
