...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "artifact-tab-list inline-flex min-h-12 items-center justify-center rounded-none border border-[hsl(var(--outline-variant)/0.18)] p-1 text-muted-foreground shadow-panel",
      className,
    )}
    {...props}
  />
