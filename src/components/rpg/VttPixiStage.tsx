...
export default memo(function VttPixiStage({
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt Optimization: Batch fog rendering into a single Graphics object
    // Creating thousands of individual Graphics objects for fog causes massive GC overhead.
