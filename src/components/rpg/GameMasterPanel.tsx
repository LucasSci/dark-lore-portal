...
export default function GameMasterPanel() {
  ...
  // ⚡ Bolt: Replace map and spread with single-pass loop
  // What: Replace array spread Math.max(...map()) with a single-pass for loop.
  // Why: Avoids Maximum call stack size exceeded errors for large collections and reduces intermediate array allocations, reducing GC pressure.
  // Impact: Improves memory efficiency and scaling robustness.
