...
export default function GameMasterPanel() {
  ...
  // ⚡ Bolt: Replaced spread operator and array map with a single-pass for loop
  // What: Calculates max chapter number without intermediate map and spread operator.
  // Why: Avoids "Maximum call stack size exceeded" errors with large arrays and reduces GC pressure.
  // Impact: Reduces GC allocations and fixes potential stack limits for large datasets.
