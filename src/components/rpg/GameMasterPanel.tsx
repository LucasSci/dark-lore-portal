...
export default function GameMasterPanel() {
  ...
  const nextChapter = useMemo(
    () => {
      // ⚡ Bolt: Replace Math.max spread map with single-pass loop
      // What: Avoid intermediate array allocation and spread operator limits
      // Why: Reduces GC pressure and prevents stack overflow on large arrays
      // Impact: Significant performance improvement in calculation
      let maxChapter = 1;
