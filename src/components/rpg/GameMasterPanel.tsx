...
export default function GameMasterPanel() {
  ...
  const nextChapter = useMemo(() => {
    ...
    // What: Replaced spread syntax and array mapping with a for loop.
    // Why: Prevents "Maximum call stack size exceeded" errors on large datasets and reduces GC allocations.
    // Impact: Eliminates intermediate array allocations and safely handles arbitrarily large publication collections.
    let max = 1;
