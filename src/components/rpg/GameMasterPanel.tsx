...
export default function GameMasterPanel() {
  ...
  const nextChapter = useMemo(() => {
    // ⚡ Bolt: Single-pass for loop replaces map + spread operator
    // Why: Prevents "Maximum call stack size exceeded" on large publication lists
    // and eliminates GC overhead from intermediate array mapping.
    let max = 1;
