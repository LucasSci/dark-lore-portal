...
export default function GameMasterPanel() {
  ...
  const nextChapter = useMemo(() => {
    // ⚡ Bolt: Prevent call stack limits and unnecessary GC pressure
    // What: Compute max chapter number using single-pass for loop instead of map+spread
    // Why: Spreading mapped arrays can exceed call stack size and creates garbage
    // Impact: Safe execution for large datasets with lower memory overhead
    let max = 1;
