        ...
        <CardContent className="space-y-3">
          {selectedToken ? (
            <>
              ...
              <div className="grid grid-cols-3 gap-2">
                <Button variant="outline" onClick={() => onAdjustHp(selectedToken.id, -5)} title="Remover 5 HP" aria-label="Remover 5 HP">
                  -5 HP
                </Button>
                <Button variant="outline" onClick={() => onAdjustHp(selectedToken.id, 5)} title="Adicionar 5 HP" aria-label="Adicionar 5 HP">
                  +5 HP
                </Button>
