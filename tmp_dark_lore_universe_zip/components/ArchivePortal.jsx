...
/**
 * ArchivePortal renders the final section of the Universe page, inviting users
 * to delve deeper into specific categories of the lore. Each portal card
 * represents a doorway to a larger archive (creatures, realms, artifacts,
 * chronicles). Cards glow and lift slightly on hover to create the
 * impression of latent magic.
 */
