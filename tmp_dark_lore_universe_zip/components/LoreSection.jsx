...
/**
 * LoreSection displays a two‑column block of text and imagery on a parchment
 * background. It is used to introduce sections of the Universe page such as
 * the world introduction or other narrative segments. The component accepts
 * a title, text content, and an optional image path. When no image is
 * provided the text spans the full width on small screens.
 */
