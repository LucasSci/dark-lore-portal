...
## 2024-05-18 - Batching identical shapes in PIXI Graphics
**Learning:** In PIXI.js, creating thousands of individual `Graphics` objects for repeated identical shapes (like grid cells, fog cells, or wall segments) in a hot path causes massive GC overhead.
