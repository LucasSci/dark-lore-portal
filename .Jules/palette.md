...
## 2024-05-24 - Replacing Native Confirm Dialogs
**Learning:** Replaced a native `window.confirm` dialog with a consistent React component to match the UI system while addressing accessibility (button labels, keyboard navigation, and focus states).
**Action:** Use existing `ConfirmActionDialog` UI wrappers for destructive actions going forward.
